                  ...
                  <div className="pt-4 mt-4 border-t border-gray-100 dark:border-gray-800/80 flex items-center justify-between">
                    ...
                    <div className="flex gap-1.5">
                      ...
                      <button
                        ...
                        className="px-4 py-2 text-xs font-bold text-white bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl hover:from-blue-700 hover:to-purple-700 shadow-md"
                      >
                        Enroll
                      </button>
                    </div>
            ...
            <div className="flex justify-between items-center border-t border-gray-100 dark:border-gray-800/80 pt-5 mt-4">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="px-6 py-2 bg-gradient-to-r from-blue-600 to-purple-600 hover:opacity-90 text-xs font-bold text-white rounded-xl shadow"
                >
                  Enroll Now
                </button>
              </div>
