              ...
              <div className="grid md:grid-cols-2 gap-6 items-start">
                <div className="space-y-4 bg-white dark:bg-slate-900 p-5 rounded-xl border border-slate-100 dark:border-slate-800">
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="w-full py-3 bg-gradient-to-r from-blue-600 to-purple-500 text-white rounded-xl text-xs font-bold hover:opacity-90 disabled:opacity-50 transition-all flex items-center justify-center gap-2"
                  >
